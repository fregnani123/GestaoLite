...
const {insertSubGrupo, insertGrupo, insertTamanhoLetras, insertTamanhoNumeros,
    insertUnidadeMassa, insertUnidadeVolume, insertUnidadeComprimento, insertUnidadeEstoque, insertFornecedorPadrao, insertCorProduto, insertClienteDefault,insertTaxaDefault,insertMarca
    ...
    if (dbInitialized && !dbTableInitialized) {
        ...
        try {
            ...
            const tables = [
                ...
                { name: 'marca', insertFunc: insertMarca }
            ];
